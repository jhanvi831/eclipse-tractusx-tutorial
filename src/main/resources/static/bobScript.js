function showContent(section) {
  ...
  switch (section) {
    ...
    case "assets":
      content = "bobasset.html";
      break;

    case "policies":
      content = "bobpolicies.html";
      break;

    case "contractDefinition":
      content = "bobcontractDefinition.html";
      break;
...
async function saveAsset() {
  ...
  try {
    const response = await fetch("http://localhost:8080/api/v1/asset/bob", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    });
...
async function fetchAssets() {
  try {
    const response = await fetch(
      "http://localhost:8080/api/v1/asset/bob/allAssets",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      }
...
async function searchAssetById() {
  ...
  try {
    const response = await fetch(
      `http://localhost:8080/api/v1/asset/bob/${assetId}`
    );
...
async function savePolicy() {
  ...
  try {
    ...
    const response = await fetch("http://localhost:8080/api/v1/policy/bob", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload),
    });
...
async function fetchPolicies() {
  try {
    const response = await fetch(
      "http://localhost:8080/api/v1/policy/bob/allPolicies",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      }
...
async function searchPolicyById() {
  ...
  try {
    const response = await fetch(
      `http://localhost:8080/api/v1/policy/bob/${policyId}`
    );
...
async function saveContract() {
  ...
  try {
    const response = await fetch(
      "http://localhost:8080/api/v1/contract-definitions/bob",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(payload),
...
async function fetchContracts() {
  try {
    const response = await fetch(
      "http://localhost:8080/api/v1/contract-definitions/bob/allContracts",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      }
...
async function searchContractById() {
  ...
  try {
    const response = await fetch(
      `http://localhost:8080/api/v1/contract-definitions/bob/${contractId}`
    );
...
function displayCatalog(catalogs) {
  ...
  if (tableContainer.style.visibility === "visible") {
    ...
    const datasets = Array.isArray(catalogs["dcat:dataset"])
      ? catalogs["dcat:dataset"]
      : [catalogs["dcat:dataset"]];

    datasets.forEach((dataset) => {
      const policy = Array.isArray(dataset["odrl:hasPolicy"])
...
async function initateNegotiation() {
  ...
  try {
    ...
    const response = await fetch(
      "http://localhost:8080/api/v1/contract-negotiations",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(payload),
...
async function fetchNegotiations() {
  try {
    const response = await fetch(
      "http://localhost:8080/api/v1/contract-negotiations/allNegotiations",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      }
...
async function searchNegotiationById() {
  ...
  try {
    const response = await fetch(
      `http://localhost:8080/api/v1/contract-negotiations/${negotiationId}`
    );
...
async function addNegotiationToTable(
  negotiationId,
  type,
  state,
  counterPartyId,
...
async function fetchTransfers() {
  try {
    const response = await fetch(
      "http://localhost:8080/api/v1/transfers/allTransfers",
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      }
